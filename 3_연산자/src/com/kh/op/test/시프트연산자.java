...
public class 시프트연산자 {
	...
	public void testMethod(){
		...
		System.out.println(num1 + " & " + num2 + " = " + (num1 & num2)); // 00001000 == 8
		
		// or 연산 : 둘 중 하나가 1이면 결과가 1인 연산법
		System.out.println(num1 + " | " + num2 + " = " + (num1 | num2)); // 00001011 == 11
		
		// xor 연산 : 두 비트가 같으면 0, 다르면 1인 결과를 출력하는 연산법
		System.out.println(num1 + " ^ " + num2 + " = " + (num1 ^ num2)); // 00000011 == 3
		...
		// 00001010
		// 00010100
		System.out.println(num1 + " << " + shft + " = " + (num1 << shft));
